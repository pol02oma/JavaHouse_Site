...
$auto = '';
if($autoplay=='1'){
	$auto = 'setTimeout(function(){video.play();}, 100);';
}
$ended = '';
$button = '';
$pp = '';
...
<html>
	<head>
		...
		<script type="text/javascript" src="../../../libraries/videobox/js/video.js"></script>
		<script type="text/javascript">			
			...
			function incN(){
				str = \'<video id="vb-player" class="video-js vb-default-skin" width="100%" poster="'.$poster.'" height="100%" controls preload="none" >\' + sou + \'</video>\';
				n++;
				if(onl){
		...
		<link href="../../../libraries/videobox/css/video-js.min.css" rel="stylesheet" type="text/css">
